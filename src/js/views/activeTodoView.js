...
class ActiveTodoView extends AllTodoView{
    ...
    todos.forEach(todo => {
      ...
      const markup = `
        ...
        <span class="todo-text ml-2 text-gray-700 dark:text-gray-200 transition-colors duration-300">${todo.text}</span>
        </label>
        </div>
      `
...
export default new ActiveTodoView()